...
public class OrdenCompraController {
	 private final OrdenCompraService ordenCompraService;
	    ...
	    @GetMapping("listadoTito")
	    public String listado(Model model) {
	        model.addAttribute("lstOrdenes", ordenCompraService.getAll());
	        return "orden/listadoTito";
	    }

	    @GetMapping("nuevoTito")
	    public String nuevo(Model model) {
	        model.addAttribute("lstProveedores", proveedorService.getAll());
	        model.addAttribute("ordenCompra", new OrdenCompraTito());
	        return "orden/nuevoTito";
	    }

	    @PostMapping("registrar")
	    public String registrar(@ModelAttribute OrdenCompraTito ordenCompra,
	        ...
	        return "redirect:/orden/listadoTito";
	    }

	    @GetMapping("edicionTito/{id}")
	    public String edicion(@PathVariable Integer id, Model model) {
	        model.addAttribute("lstProveedores", proveedorService.getAll());
	        model.addAttribute("ordenCompra", ordenCompraService.getOne(id));
	        return "orden/edicionTito";
	    }

	    @PostMapping("guardarTito")
	    public String guardar(@ModelAttribute OrdenCompraTito ordenCompra,
	                           Model model, RedirectAttributes flash) {
